...
> [!NOTE]
> The version constraint uses a very basic [syntax and algorithm](https://github.com/cedx/setup-hashlink/blob/main/src/Release.cs#L85), but it should suffice in most cases.  
